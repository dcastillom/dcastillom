        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- <form class="form-horizontal" method="PUT" action="{{route('introduction.update', $introduction->id)}}" enctype="multipart/form-data"> -->
                    <form class="form-horizontal"  method="POST" action="{{route('introduction.update', $introduction->id)}}" enctype="multipart/form-data">
                        {{ csrf_field() }}          
                            ...
                            <div class="col-md-2">
                                <select id="lang" class="form-control" name="lang" >
                                    @foreach ($langs as $key=>$value)
                                        <option value="{{$value}}" @if ($introduction->lang == $value) selected="selected" @endif> {{ $value }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('lang'))
                        ...
                        <div class="form-group{{ $errors->has('greeting') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea id="greeting" type="text" class="form-control" name="greeting" required autofocus>{{ $introduction->greeting }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('intro') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea id="intro" type="text" class="form-control" name="intro" required autofocus>{{ $introduction->intro }}</textarea>
                                @if ($errors->has('intro'))
                                    <span class="help-block">
